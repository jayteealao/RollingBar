    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/jayteealao/rollingbar/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/jayteealao/rollingbar.git")
                    developerConnection.set("scm:git:ssh://github.com/jayteealao/rollingbar.git")
                    url.set("https://github.com/jayteealao/rollingbar/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/jayteealao/rollingbar/issues")
                }
            }
        }
    }
